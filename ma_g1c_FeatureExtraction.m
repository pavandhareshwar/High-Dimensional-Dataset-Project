function FeatureExtraction(in_file,out_dir,outFileName)
%%
...
%% outFileName: name of the features.mat file 
%%
%% in_file format (text):
...
if nargin~=3,
    error('Number of input arguments is not 3. (try "help FeatureExtraction")')
end
